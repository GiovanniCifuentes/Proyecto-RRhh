...
public class MdiGeneral extends javax.swing.JFrame {
    ...
    private void mnuCatalogosMantenimientosEmpleadosActionPerformed(java.awt.event.ActionEvent evt) {
        // Crear las instancias necesarias para el controlador
        EmpleadoVista vistaEmpleado = new EmpleadoVista();  // Instancia de EmpleadoVista
        EmpleadoDAO empleadoDAO = new EmpleadoDAO();         // Instancia de EmpleadoDAO
    
        // Crear el controlador pasándole las instancias
        EmpleadoControlador controladorEmpleado = new EmpleadoControlador(vistaEmpleado, empleadoDAO);
        
        // Agregar la vista de empleados al jDesktopPane
        jDesktopPane1.add(vistaEmpleado); // Aquí agregas la vista en lugar del controlador
    
        // Centrar la ventana en el escritorio
        Dimension desktopSize = jDesktopPane1.getSize();
        Dimension frameSize = vistaEmpleado.getSize(); // Usamos vistaEmpleado, no el controlador
        vistaEmpleado.setLocation((desktopSize.width - frameSize.width) / 2, 
    ...
    private void initComponents() {
        ...
        mnuCatalogosMantenimientosEmpleados = new JMenuItem("Mantenimiento Empleados");
        ...
        mnuCatalogosMantenimientosEmpleados.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuCatalogosMantenimientosEmpleadosActionPerformed(evt);
            }
        });
        ;
